package com.validator.validatorservice;
...
public class ValidatorServiceApplication {
	...
	private ApiInfo generateApiInfo() {
		return new ApiInfo("Jumuia Phone Service",
				"This service is tasked to view valid and invalid phone numbers for various countries inAfrica.",
				"Version 1.0 - mw", "", "", "Apache 2.0",
